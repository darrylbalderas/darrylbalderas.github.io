...
The motivation behind this project was that I wanted to move away from manual "button-clicking" and toward a highly automated infrastructure that I can rip apart and build again from scratch. The goal was simple: **minimal-touch bare metal provisioning.** I pre-register MAC addresses and do a manual power cycle per node, but beyond that, each machine provisions itself and joins a production-ready Kubernetes cluster without me ever running an installer by hand.
