...
I have a Github [repository](https://github.com/darrylbalderas/public-projects/tree/main/krusty-krab) that contains example of using this API. In this example. I do the following
...
Here is a snippet of the [code](https://github.com/darrylbalderas/public-projects/blob/main/krusty-krab/main.go) itself.
...
func validateOverlaysFolders(fs filesys.FileSystem, kustomizationDir string) {
 ...
 if err != nil {
  panic(fmt.Errorf("error with converting kustomization output to yaml: %v", err))
 }
}
