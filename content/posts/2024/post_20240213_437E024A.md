...
For quickly getting up a modern HTTP API server, I use [Fastapi](https://fastapi.tiangolo.com/), and for more seasoned APIs, I use [Django](https://www.djangoproject.com()).
...
<https://github.com/darrylbalderas/public-projects/tree/main/helloworld-python-grpc>
...
1. Modify import statements in `greeter_server.py,` `greeter_client.py`, and `protos/helloworld_pb2_grpc.py` to point to the correct Python proto buff generated code. For example;
