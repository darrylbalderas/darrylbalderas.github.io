...
Coding exists in this [repository](https://github.com/darrylbalderas/public-projects/tree/main/be-kind-to-yourself)

1. To get started, you must install KIND `brew install kind`

2. Clone [repository](https://github.com/darrylbalderas/public-projects/tree/main/be-kind-to-yourself)
...
5. Create local docker image for local [kind_app](https://github.com/darrylbalderas/public-projects/tree/main/be-kind-to-yourself/kind_app) by running `make build`

6. Move to [project directory](https://github.com/darrylbalderas/public-projects/tree/main/be-kind-to-yourself) and load image in kind cluster `make load_image`

7. Once the image gets loaded in the KIND cluster, you can deploy Kubernetes [deployment](https://github.com/darrylbalderas/public-projects/blob/main/be-kind-to-yourself/manifests/deployment.yaml) by running `make deploy`
